...
tx = Transaction()
tx.inputs.append("fake_input")
tx.outputs.append("fake_output")

# Add the signature to the transaction
tx_signed = tx.sign(pubkey, sig)

# Check if the transaction is valid
assert tx_signed.verify()

# Print the verification result
print("Transaction verification:", tx_signed.verify())
